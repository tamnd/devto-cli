...
// HTTP behaviour is covered in devto_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "devto://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("devto", "about")
	if err != nil || got.String() != "devto://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want devto://page/about", got.String(), err)
	}
}
